    ...
    <div className={`${sizeClass} rounded-xl relative overflow-hidden shadow-2xl flex-shrink-0`}
      ...
      <div className="absolute inset-3 flex flex-col justify-between">
        ...
        <div>
          ...
          <div className="mt-2 text-xs font-bold" style={{ color: '#fcd34d' }}>{book.price}</div>
        </div>
      </div>
      {/* Decorative corner */}
              ...
              <div key={book.id} className="book-card rounded-2xl overflow-hidden"
                ...
                <div className="p-6 flex gap-4 items-start"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-2xl font-black" style={{ color: '#f97008' }}>₹{book.price}</div>
                    <div className="text-xs mt-1" style={{ color: '#9a7055' }}>+ ₹{book.courier} = ₹{book.price + book.courier}</div>
                  </div>
                </div>
